...
def api_learn():
    ...
    if entity_id in engine.entities:
        ...
        target = Entity(id=entity_id, name=char_name, category="crowdsourced", probs={})
    ...
    return jsonify(
        {"message": f"Successfully learned/updated parameters for '{char_name}'!"}
    )
...
def get_engine_state():
    ...
    return jsonify({"status": "give_up", "top_candidates": top_data})
